...
// (the "colorful" variant) exactly, so the two native apps share one look.
enum Wave {
    ...
    static let bubbleOutEnd = Color(red: 0x40 / 255, green: 0x5D / 255, blue: 0xAC / 255)
