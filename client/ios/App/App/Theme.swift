...
enum Wave {
    ...
    static let panel2 = Color(red: 0x1C / 255, green: 0x1C / 255, blue: 0x1E / 255)
    static let elevated = Color(red: 0x20 / 255, green: 0x2A / 255, blue: 0x38 / 255)
    static let border = Color(red: 0x23 / 255, green: 0x23 / 255, blue: 0x26 / 255)
    ...
    static let bubbleIn = Color(red: 0x1C / 255, green: 0x1C / 255, blue: 0x1E / 255)
    static let online = Color(red: 0x5F / 255, green: 0xD3 / 255, blue: 0xA0 / 255)

    static let bubblePinkStart = Color(red: 0xE7 / 255, green: 0x59 / 255, blue: 0xA8 / 255)
    static let bubblePinkEnd = Color(red: 0xB4 / 255, green: 0x4A / 255, blue: 0xE0 / 255)
    ...
    static let bubbleOutGradient = LinearGradient(
        colors: [bubblePinkStart, bubblePinkEnd],
        startPoint: .topLeading,
        endPoint: .bottomTrailing
    )
}
